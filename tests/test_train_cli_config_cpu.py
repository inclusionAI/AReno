...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("gpu_stats_interval_s", 0.0, "--gpu-stats-interval-s must be positive"),
        ("gpu_stats_history", 0, "--gpu-stats-history must be positive"),
...
def _options(**overrides):
    defaults = dict(
        ...
        gpu_stats=False,
        gpu_stats_interval_s=5.0,
        gpu_stats_history=1000,
        agent_fn=None,
