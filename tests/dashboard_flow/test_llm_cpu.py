...
from areno.dashboard.flow.datasets import save_dataset, save_function
from areno.dashboard.flow.llm import ScriptGenerator, dataset_sample
...
def test_generation_passes_context_and_returns_complete_script(monkeypatch, setup):
    ...
    monkeypatch.setattr("areno.dashboard.flow.llm.urllib.request.build_opener", lambda *args: Client())
