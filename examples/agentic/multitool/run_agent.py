...
TOOLS: list[dict] = [CONTACTS_TOOL, NOTES_TOOL, CALCULATOR_TOOL, UNIT_CONVERT_TOOL, PARCEL_TOOL, SEARCH_NOTES_TOOL, LIST_CONTACTS_BY_CITY_TOOL]
TOOL_BY_NAME = {str(tool["function"]["name"]): tool for tool in TOOLS}
