...
.app{width:min(1100px,98vw);height:calc(100vh - 20px);display:grid;grid-template-columns:auto minmax(220px,260px) minmax(240px,1fr);gap:12px;align-items:stretch}
...
.stats{display:flex;gap:8px;flex-wrap:wrap;margin:10px 0 6px}.pill{background:#fff;border:3px solid #27313a;border-radius:999px;padding:6px 10px;font-weight:1000}
...
.event{background:#fff;border:3px solid #27313a;border-radius:12px;padding:8px 10px;font-weight:800;height:36px;min-height:36px;box-sizing:border-box;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
