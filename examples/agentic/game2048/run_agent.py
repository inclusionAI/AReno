...
The agent runs multiple episodes concurrently via AsyncOpenAI. For each
board in the batch, it plays up to DEFAULT_MAX_MOVES turns, collecting
all tool calls and messages into an AgentTrajectory for reward computation.
"""
