...
Provides a browser-based visual interface to play 2048 against a served
model. The UI renders the board with classic 2048 tile colors, sends move
requests to the OpenAI-compatible endpoint, and displays the model's
