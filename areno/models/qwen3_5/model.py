...
class Qwen35GatedDeltaNet(nn.Module):
    ...
    def _forward_train(
        ...
        # Rollout decode uses the recurrent kernel. Recompute with the same
        # recurrence so long hybrid sequences do not accumulate a material
        # chunk-vs-recurrent logprob drift.
        log_once("qwen35_gdn_fla_recurrent_train", "using FLA recurrent gated-delta training kernel")
